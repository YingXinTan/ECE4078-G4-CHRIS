...
class OutputWriter:
    def __init__(self, folder_name="output/",mode=""):
        ...
        operate_modes = ["","_ARUCO", "_CV"]
        self.img_f = open(folder_name+"images.txt", 'w')   
        self.map_f = folder_name+"slam"+operate_modes[mode]+".txt"
    ...
    def write_map(self, slam):
        map_dict = {"taglist":slam.taglist,
                    ...
                    "final_robot_pose":slam.robot.state.tolist()}
