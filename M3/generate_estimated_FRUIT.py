...
if __name__ == '__main__':
    ...
    parser.add_argument("--estimate", default='lab_output/slam_CV.txt')
    ...
    # est_fname = "lab_output/slam_CV.txt"
    ...
    us_vec = us_vec[:,idx]
    gt_vec = gt_vec[:, idx]
    # -------------------- CHRIS: change the aruco user vector with the one we painstakingly adjusted in EST_ARUCO.txt --------------------
    # reading in the slam map
    ...
    if args.tf == 1:
        ...
        us_vec_aligned = us_vec # don't touch the aruco markers
    ...
    # save estimated map as EST_TRUEMAP.txt
    with open("EST_TRUEMAP.txt", 'w') as map_f:
