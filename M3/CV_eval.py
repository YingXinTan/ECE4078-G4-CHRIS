...
def CV_eval():
    truth_fname = "TRUEMAP.txt"
    est_fname = "lab_output/targets.txt"

    # read in ground truth and estimations
    redapple_gt, greenapple_gt, orange_gt, mango_gt, capsicum_gt = parse_map(truth_fname)
    redapple_est, greenapple_est, orange_est, mango_est, capsicum_est = parse_map(est_fname)
...
if __name__ == '__main__':
    ...
    target_score = (1-av_dist)/(1-0.025)*16 + 5.0*0.8
