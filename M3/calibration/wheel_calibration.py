...
def calibrateWheelRadius():
    ...
    #The scale parameter is estimated as 0.015008 m/ticks.
    ...
    ##########################################
    wheel_velocities_range = range(27, 27+15, 5)  # or use np.linspace
    delta_times = []
...
def calibrateBaseline(scale):
    ...
    #The baseline parameter is estimated as 0.114653 m.
    ...
    wheel_velocities_range = range(spd, spd+15, 5)  # or use np.linspace
    delta_times = []
    ...
    for delta_time, wheel_vel in zip(delta_times, wheel_velocities_range):
        ...
        baseline += (delta_time * wheel_vel * scale) / (num * np.pi)
